...
GjN1_GjjN1_1000 = plotterInput(lineColor_=kRed+1,histoTag_="GjN1_GjjN1_1000",legLabel_="#tilde{g}(j#tilde{#chi}^{0}),#tilde{g}(jj#tilde{#chi}^{0})",stack_=False)
...
GjjN1_GjjjN1_1000 = plotterInput(lineColor_=kYellow+0,histoTag_="GjjN1_GjjjN1_1000",legLabel_="#tilde{g}(jj#tilde{#chi}^{0}),#tilde{g}(jjj#tilde{#chi}^{0})",stack_=False)
GjjjN1_GjjjN1_1000 = plotterInput(lineColor_=kYellow+0,histoTag_="GjjjN1_GjjjN1_1000",legLabel_="#tilde{g}(jjj#tilde{#chi}^{0}),#tilde{g}(jjj#tilde{#chi}^{0})",stack_=False)
GjjjN1_GjjjN1_1000.lineStyle=2
GjjjN1_GjjjjN1_1000 = plotterInput(lineColor_=kOrange+0,histoTag_="GjjjN1_GjjjjN1_1000",legLabel_="#tilde{g}(jjj#tilde{#chi}^{0}),#tilde{g}(jjjj#tilde{#chi}^{0})",stack_=False)
GjjjjN1_GjjjjN1_1000 = plotterInput(lineColor_=kOrange+0,histoTag_="GjjjjN1_GjjjjN1_1000",legLabel_="#tilde{g}(jjjj#tilde{#chi}^{0}),#tilde{g}(jjjj#tilde{#chi}^{0})",stack_=False)
